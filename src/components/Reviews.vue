      ...
      <div class="lg:col-span-5 lg:col-start-1">
        ...
        <div class="mb-8">
          <h2 class="mb-2 text-3xl text-gray-800 font-bold lg:text-4xl">
            É tudo sobre digitalização
          </h2>
          <p class="text-gray-600">
            Acreditamos que a colaboração é a base de tudo.
            <br>
            Vamos fazer a diferença e preservar os arquivos juntos!
          </p>
        </div>
        <!-- End Title -->
        ...
        <blockquote class="relative">
          ...
          <div class="relative z-10">
            <p class="text-xl italic text-gray-800">
              Um projeto incrível, feito para pessoas que desejam fazer a diferença no mundo!
            </p>
          </div>
          ...
          <footer class="mt-6">
            <div class="flex items-center">
              ...
              <div class="grow ms-4">
                <div class="font-semibold text-gray-800">João</div>
                <div class="text-xs text-gray-500">Diretor de Tecnologia & Inovação | XYZ</div>
              </div>
            </div>
          </footer>
        </blockquote>
          ...
          <ul class="grid grid-cols-2 divide-y divide-y-2 divide-x divide-x-2 divide-gray-200 overflow-hidden">
            <li class="flex flex-col -m-0.5 p-4 sm:p-8">
              ...
              <p class="text-sm sm:text-base text-gray-600">
                usuários - de estudantes a pesquisadores
              </p>
            </li>

            <li class="flex flex-col -m-0.5 p-4 sm:p-8">
              <div class="flex items-end gap-x-2 text-3xl sm:text-5xl font-bold text-gray-800 mb-2">
                <svg class="flex-shrink-0 size-5 text-blue-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m5 12 7-7 7 7"/><path d="M12 19V5"/></svg>
                45%
              </div>
              <p class="text-sm sm:text-base text-gray-600">
                de crescimento anualmente
              </p>
            </li>
            ...
            <li class="flex flex-col -m-0.5 p-4 sm:p-8">
              ...
              <p class="text-sm sm:text-base text-gray-600">
                de documentos digitalizados de todo o acervo
              </p>
            </li>
