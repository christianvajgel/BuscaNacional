        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            ...
            <div class="text-center">
              ...
              <div>
                <img src="https://static.vecteezy.com/system/resources/previews/021/462/610/non_2x/scan-me-free-png.png" style="max-width: 25%; height: auto; margin: 0 auto;" alt=""/>
              </div>


              <h1 class="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight">
                Unindo o passado ao <span class="text-blue-500">futuro</span>
              </h1>
            </div>
            <!-- End Title -->
            ...
            <div class="sm:flex sm:justify-center sm:items-center text-center sm:text-start">
              ...
              <span class="text-xs font-medium leading-none text-white uppercase">10k+</span>
            </span>
                </div>
                <!-- End Avatar Group -->
              </div>
              ...
              <div class="pt-5 sm:pt-0 sm:ps-5">
                <div class="text-lg font-semibold text-gray-800">Faça parte desta comunidade!</div>
                <div class="text-sm text-gray-500">Junte-se a mais de 10 mil usuários</div>
              </div>
            </div>
            <!-- End Avatar Group -->
            ...
            <label for="hs-hero-name-1" class="block text-sm font-medium"><span class="sr-only">Seu nome</span></label>
                <input type="text" id="hs-hero-name-1" class="py-3 px-4 block w-full border-transparent rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Nome">
              </div>
              <div class="pt-2 sm:pt-0 sm:ps-3 border-t border-gray-200 sm:border-t-0 sm:border-s sm:flex-[1_0_0%]">
                <label for="hs-hero-email-1" class="block text-sm font-medium"><span class="sr-only">Seu email</span></label>
                <input type="email" id="hs-hero-email-1" class="py-3 px-4 block w-full border-transparent rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Email">
              </div>
              <div class="pt-2 sm:pt-0 sm:ps-3 border-t border-gray-200 sm:border-t-0 sm:border-s sm:flex-[1_0_0%]">
                <label for="hs-hero-email-1" class="block text-sm font-medium"><span class="sr-only">Sua senha</span></label>
                <input type="password" id="hs-hero-email-1" class="py-3 px-4 block w-full border-transparent rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Senha">
              </div>
      ...
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="h-52 flex flex-col justify-center items-center rounded-t-xl">
              ...
              <img src="https://i.ibb.co/5W2mShL/mapa-antigo.jpg" class="rounded-lg" style="max-width: 70%; height: auto;" alt=""/>
        ...
        <span class="block mb-1 text-xs font-semibold uppercase text-blue-600">
          Setor cartográfico
              ...
              <p class="mt-3 text-gray-500">
                Guias para o desconhecido, desenhando caminhos e explorando o mundo com tinta e papel.
              </p>
            </div>
            <div class="mt-auto flex border-t border-gray-200 divide-x divide-gray-200">
              <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-es-xl bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" href="/adicionar">
                Adicionar
              </a>
              <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-ee-xl bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" href="/listar">
                Listar
              </a>
            </div>
          </div>
          ...
          <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="h-52 flex flex-col justify-center items-center rounded-t-xl">
              ...
              <img src="https://mapa.an.gov.br/images/BR_RJANRIO_AN_ICN_FOT_137_12.jpg" class="rounded-lg" style="max-width: 62%; height: auto;" alt=""/>
        ...
        <span class="block mb-1 text-xs font-semibold uppercase text-rose-600">
          Setor Mídia
              ...
              <p class="mt-3 text-gray-500">
                Janelas para o passado, revelando memórias e histórias em tons sépia
              </p>
            </div>
            <div class="mt-auto flex border-t border-gray-200 divide-x divide-gray-200">
              <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-es-xl bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" href="/adicionar">
          ...
          <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="h-52 flex flex-col justify-center items-center rounded-t-xl">
              ...
              <img src="https://i.ytimg.com/vi/TV0Y1qG_4-A/maxresdefault.jpg" class="rounded-lg" style="max-width: 81%; height: auto;" alt=""/>
